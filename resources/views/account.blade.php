...
<body>
    ...
    <nav>
        ...
        <ul class="navbar">
            ...
            <li><a href="#ourservice" style="text-decoration: none;">Our Service</a></li>
            <li><a href="#contact" style="text-decoration: none;">Contact</a></li>
            <li><a href="#about" style="text-decoration: none;">About</a></li>
        </ul>
        <div class="nav-btn">
            <a href="#" class="account"><img src="img/Avatar.png" alt=""></a>
            <a href="{{ url('/account') }}" class="Acc-page" style="text-decoration: none;">Nama</a>
            <a href="{{ url('/') }}" class="log-out" style="text-decoration: none;">Log Out</a>
        </div>
    </nav>
    <br>
    <br>
...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold">BillySpion</span><span class="text-black-50">billyspion@gmail.com</span><span><a href="">Change Password</a></span></div>
        </div>
